...
if __name__ == "__main__":
    ...
    encodings_train = tokenizer(dataset_train.sentences, truncation=True, padding=True)
    encodings_valid = tokenizer(dataset_valid.sentences, truncation=True, padding=True)
